...
|#
 ...
 (defunc TriXOR (x y z)
   ...
   (cond
    ((equal x t) (if (and (equal y nil) (equal z nil)) t nil))
    ((equal y t) (if (equal z nil) t nil))
    (t (if (equal z t) t nil))))
...
(defunc how-many (e l)
  ...
  (cond
   ((endp l) 0)
   (t (if (equal (first l) e)
        (+ 1 (how-many e (rest l)))
        (how-many e (rest l))))))
  
(check= (how-many  1 ())     0)
(check= (how-many  1 '(1 1)) 2)
(check= (how-many  1 '(2 1 2 1 2)) 2)
(check= (how-many t '(1 2 3)) 0)
(check= (how-many nil '(1 4 nil nil)) 2)
...
(defunc same-multiplicity (l l1 l2)
  ...
  (cond
   ((or (endp l) (endp l1) (endp l2)) nil)
   ((equal (how-many (first l) l1) (how-many (first l) l2))
    (if (endp (rest l)) t (same-multiplicity (rest l) l1 l2)))))
  
(check= (same-multiplicity '(1)   '(2 1 3) '(1 2 2)) t)
(check= (same-multiplicity '(1 2) '(2 1 3) '(1 2 2)) nil)
(check= (same-multiplicity '(1 2 3) '(1 3 3) '(4 5 3 1 3)) t)
(check= (same-multiplicity '(t nil 5) '(t t 5 6 nil) '(nil 9 1 5 t 6 t)) t)
(check= (same-multiplicity () '(1 2 3) '(t)) nil)
(check= (same-multiplicity '(8) () '(5 6)) nil)
(check= (same-multiplicity '(4) '(4 4) ()) nil)
...
(check= (flat-listp '(t t t t t)) t)
(check= (flat-listp ()) t)
(check= (flat-listp '(() 8 6 5 3 2 t '(() 8 7 6))) nil)
...
(defunc merge-lists (l1 l2)
  ...
  (if (or (endp l1) (endp l2))
    (append l1 l2)
  (cons (first l1) (cons (first l2) (merge-lists (rest l1) (rest l2))))))
  
(check= (merge-lists '(a b c d) '(1 2 3 4 5))
        '(a 1 b 2 c 3 d 4 5))
(check= (merge-lists () ()) ())
(check= (merge-lists '( 1 2 3) ()) '(1 2 3))
(check= (merge-lists '(t t t) '(1 2 3 4 5)) '(t 1 t 2 t 3 4 5))
...
(defunc flatten-list (l)
  ...
  (cond 
   ((endp l) ())
   (t (if (listp (first l)) 
        (append (flatten-list (first l)) (flatten-list (rest l)))
        (cons (first l) (flatten-list (rest l)))))))
  
(check= (flatten-list '((1 2 3) nil 4 (5 6))) '(1 2 3 4 5 6))
(check= (flatten-list '(1 2 (3 (4)) t nil)) '(1 2 3 4 t))
(check= (flatten-list ()) ())
; Add additional tests.
